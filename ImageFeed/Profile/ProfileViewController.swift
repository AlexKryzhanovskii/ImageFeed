...
final class ProfileViewController: UIViewController {
   ...
   @objc private func didTapLogoutButton() { }
    ...
    private func createLogOutButton() {
        ...
        button.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 64).isActive = true
    ...
    private func createLabelsForProfile() {
        ...
        NSLayoutConstraint.activate([
            labelFullName.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 118),
